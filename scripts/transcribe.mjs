...
const scratch =
  "C:\\Users\\FCI\\AppData\\Local\\Temp\\claude\\C--Users-FCI-Downloads-New-folder-my-video\\d3647689-e1dc-4e87-99c6-a43ffd6579e5\\scratchpad";
...
const outDir = path.join(PROJECT_ROOT, "scripts/captions");
